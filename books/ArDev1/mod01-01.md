...
The AR System Navigator is where you navigate to if you want to create or view objects. The AR System Navigator gives
you access to:

- **Working Lists:** Lists of server objects that you use to complete an application development
  or maintenance task.
...
- **All Objects:** All the object types that you can define in BMC Remedy Developer Studio, for
  example, forms, active links, and so on.
...
![](images/mod01/p13.png){: style="width: 100%"}
</div>
<div class="col-3 align-self-center" markdown="1">

- Use the AR System Navigator to open object lists and create objects.
- Double-click an object to open the Object List to search for a specific object
- Contains a tree for each connected server
- Right-click to create a new object outside of an application
</div>
</div>
